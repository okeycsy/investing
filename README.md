...
- 장중에는 새 뉴스, 발행사 중요 SEC 공시, 내부자 거래, 큰 폭의 이상 움직임, 20거래일 평균 대비 1.5배 이상 거래량만 전송합니다. 거래량 알림은 하루 한 번만 보냅니다.
- 장마감에는 가격과 정확한 등락률 없이 `양전/음전/보합`, SOXX 상대 성과, 투자 논지와 DCA 계획을 먼저 표시하고 당일 거래량과 20일 평균을 비교합니다.
